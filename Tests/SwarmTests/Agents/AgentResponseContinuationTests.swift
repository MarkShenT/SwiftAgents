...
struct AgentResponseContinuationTests {
    ...
    func runWithResponseAutoTracksPreviousResponseID() async throws {
        ...
        let first = try await agent.runWithResponse("first prompt", session: session, hooks: nil)
        _ = try await agent.runWithResponse("second prompt", session: session, hooks: nil)
    ...
    func runAutoTracksSyntheticResponseID() async throws {
        ...
        let firstResult = try await agent.run("first prompt", session: session, hooks: nil)
        _ = try await agent.run("second prompt", session: session, hooks: nil)
    ...
    func explicitPreviousResponseIDWins() async throws {
        ...
        _ = try await agent.run("prompt", session: session, hooks: nil)
